        ...
        <div class="container-fluid">
            ...
            <section id="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="bootstrap-data-table-panel table_22">
                                <div class="table-responsive">
                                    <div id="row-select_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="dataTables_length" id="row-select_length"><label>Show
                                                        <select name="row-select_length" aria-controls="row-select"
                                            ...
                                            <div class="col-sm-6">
                                                <div id="row-select_filter" class="dataTables_filter">
                                                    <label>Search:<input type="search" class="form-control input-sm"
                                                                         placeholder=""
                                                                         aria-controls="row-select"></label></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="row-select"
                                                       class="display table table-borderd table-hover forminline_22 dataTable"
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="row-select"
                                                            ...
                                                            style="width: 460px;">Position
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="row-select"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Office: activate to sort column ascending"
                                                            style="width: 230px;">Office
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="row-select"
                                                            rowspan="1" colspan="1"
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="row-select"
                                                            ...
                                                            style="width: 201px;">Start date
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="row-select"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Salary: activate to sort column ascending"
                                                            style="width: 185px;">Salary
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    <tr>
                                                        <th rowspan="1" colspan="1"><select class="form-control">
                                                                ...
                                                                <option value="Jackson Bradshaw">Jackson Bradshaw
                                                                </option>
                                                                <option value="Jena Gaines">Jena Gaines</option>
                                                                <option value="Jenette Caldwell">Jenette Caldwell
                                                                </option>
                                                                ...
                                                                <option value="Prescott Bartlett">Prescott Bartlett
                                                                </option>
                                                                ...
                                                                <option value="Tatyana Fitzpatrick">Tatyana
                                                                    Fitzpatrick
                                                                </option>
                                                        ...
                                                        <th rowspan="1" colspan="1"><select class="form-control">
                                                                ...
                                                                <option value="Data Coordinator">Data Coordinator
                                                                </option>
                                                                <option value="Developer">Developer</option>
                                                                <option value="Development Lead">Development Lead
                                                                </option>
                                                                <option value="Director">Director</option>
                                                                <option value="Financial Controller">Financial
                                                                    Controller
                                                                </option>
                                                                ...
                                                                <option value="Pre-Sales Support">Pre-Sales Support
                                                                </option>
                                                                <option value="Regional Director">Regional Director
                                                                </option>
                                                                ...
                                                                <option value="Senior Marketing Designer">Senior
                                                                    Marketing Designer
                                                                </option>
                                                                <option value="Software Engineer">Software Engineer
                                                                </option>
                                                                <option value="Support Engineer">Support Engineer
                                                                </option>
                                                                <option value="Support Lead">Support Lead</option>
                                                                <option value="System Architect">System Architect
                                                                </option>
                                                                <option value="Systems Administrator">Systems
                                                                    Administrator
                                                                </option>
                                                                <option value="Team Leader">Team Leader</option>
                                                                <option value="Technical Author">Technical Author
                                                                </option>
                                                            </select></th>
                                                        <th rowspan="1" colspan="1"><select class="form-control">
                                                                <option value=""></option>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="dataTables_info" id="row-select_info" role="status"
                                                     aria-live="polite">Showing 1 to 10 of 57 entries
                                                </div>
                                            </div>
                                            <div class="col-sm-7">
                                                <div class="dataTables_paginate paging_simple_numbers"
                                                     id="row-select_paginate">
                                                    <ul class="pagination">
                                                        <li class="paginate_button previous disabled"
                                                            id="row-select_previous"><a href="#"
                                                        ...
                                                        <li class="paginate_button "><a href="#"
                                                                                        ...
                                                                                        data-dt-idx="6"
                                                                                        tabindex="0">6</a></li>
                                                        <li class="paginate_button next" id="row-select_next"><a
                                                                href="#" aria-controls="row-select" data-dt-idx="7"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer">
                            <p>2019 © Xtreme Admin Board by <a href="#">webstrot.</a></p>
                        </div>
                    </div>
                </div>
            </section>
